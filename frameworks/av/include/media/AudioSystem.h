...
public:
    ...
    static status_t StartOutputSamplerate (audio_io_handle_t output,audio_stream_type_t stream,int session ,int samplerate);
    static status_t StopOutputSamplerate (audio_io_handle_t output,audio_stream_type_t stream,int session ,int samplerate);
