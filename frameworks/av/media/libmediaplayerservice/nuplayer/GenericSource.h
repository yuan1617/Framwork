...
private:
	...
	int32_t mMaxUpdateDurationTimes;
#endif
		bool mIsWidevine;
    bool mUIDValid;
    uid_t mUID;
...
private:
    ...
    status_t mInitCheck;
    int64_t mSeekTimeUs;
    bool mCacheUnderRun;                  // http Streaming buffering flag
    bool mPreparing;                      // for http Streaming prepare cache data
    bool mPrepareSource;                  // for http Streaming prepare cache data
