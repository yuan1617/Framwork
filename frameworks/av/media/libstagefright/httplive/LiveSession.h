...
#ifdef MTK_AOSP_ENHANCEMENT
    sp<ABuffer> createFormatChangeBuffer(bool swap = true,uint32_t otherStream = 0);
#else
...
public:
    ...
    //handle for bandwidth decrease
    void scheduleCheckBandwidthEvent_l();
    void cancelCheckBandwidthEvent_l();
    bool canSwitchBandwidthTo_l();
    int64_t getFileSize(
...
private:
    ...
    void swapsourceAndCheck(StreamType stream,int32_t switchGeneration);
