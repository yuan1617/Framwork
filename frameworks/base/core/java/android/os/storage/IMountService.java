...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        ...
        static final int TRANSACTION_shareCDRom = IBinder.FIRST_CALL_TRANSACTION + 41;

        static final int TRANSACTION_unmountVolumeNotSwap = IBinder.FIRST_CALL_TRANSACTION + 42;

        static final int TRANSACTION_mountVolumeNotSwap = IBinder.FIRST_CALL_TRANSACTION + 43;
        /// @}
