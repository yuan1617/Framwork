...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
         ...
         * @hide
         */
        public static final String KEY_GUSTURE_SWITCH = "gesture_enable";
       ...
       /**
         ...
         */
		  ...
		  * @internal
		  */
		 public static String VIBRATE_ONCALL_CONNECTION = "vibrate_oncall_connection";

         /**
		  * @hide
		  * @internal
		  */
		 public static String FLIP_TO_MUTE = "flip_to_mute";

         /**
		  * @hide
		  * @internal
		  */
		 public static String AUTO_CALL_RECORDING = "auto_call_recording";
    }
