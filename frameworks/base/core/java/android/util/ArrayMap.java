...
public final class ArrayMap<K, V> implements Map<K, V> {
    ...
    /// M: add for tracking the dangerour mult thread operation;
    private static long static_id = 10000;
    private long id = static_id++;

    private int threadSeqCode = 0;

    private void traceStart() {
        threadSeqCode++;
        if (threadSeqCode != 1) {
            Log.e(TAG, id + ", mult Thread operation on this ArrayMap! seqCode: " + threadSeqCode, new Exception());
        }
    }
