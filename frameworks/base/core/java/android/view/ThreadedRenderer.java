...
import android.os.ParcelFileDescriptor; /// M: file descriptor of program binary
...
public class ThreadedRenderer extends HardwareRenderer {
                ...
                if (atlas.isCompatible(android.os.Process.myPpid())) {
                    ...
                    if (buffer != null) {
                        ...
                        if (map != null) {
                            ...
                            /// M: get program binaries from atlas
                            mPfd = atlas.getProgramFd();
                            if (mPfd != null) {
                                FileDescriptor fd = mPfd.getFileDescriptor();
                                int length = atlas.getProgramLength();
                                long[] programMap = atlas.getProgramMap();
                                nSetProgramAtlas(renderProxy, fd, length,
                                    programMap, programMap.length);
                            }
                        }
    ...
    private static native void nSetProgramAtlas(long nativeProxy, FileDescriptor fd,
            int length, long[] programMap, int programCount);
