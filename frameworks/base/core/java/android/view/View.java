...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    */
    ...
    public View(Context context) {
        ...
        mName = getClass().getName() + " @" + Integer.toHexString(this.hashCode());
        mRenderNode = RenderNode.create(mName, this);
   ...
   /**
    ...
    public void layout(int l, int t, int r, int b) {
        ...
        if (DBG_LAYOUT) {
            Xlog.d(VIEW_LOG_TAG, "view layout start, this =" + this + ", mLeft = "
                + mLeft + ", mTop = " + mTop
        ...
        if (changed || (mPrivateFlags & PFLAG_LAYOUT_REQUIRED) == PFLAG_LAYOUT_REQUIRED) {
            ...
            if (DBG_LAYOUT) {
                Xlog.d(VIEW_LOG_TAG, "view layout end, this =" + this + ", mLeft = " + mLeft
                        + ", mTop = " + mTop + ", mBottom = " + mBottom + ", mRight = " + mRight
                        + ", time =" + (nowTime - logTime) + " ms");
            }
    ...
    public final void measure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DBG_LAYOUT) {
            Xlog.d(VIEW_LOG_TAG, "view measure start, this =" + this
                    + ", widthMeasureSpec = " + MeasureSpec.toString(widthMeasureSpec)
                    + ", heightMeasureSpec = " + MeasureSpec.toString(heightMeasureSpec)
                    + ", mOldWidthMeasureSpec = " + MeasureSpec.toString(mOldWidthMeasureSpec)
                    + ", mOldHeightMeasureSpec = " + MeasureSpec.toString(mOldHeightMeasureSpec));
        }
