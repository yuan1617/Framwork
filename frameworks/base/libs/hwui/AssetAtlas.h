...
public:
    ...
    AssetAtlas(): mTexture(NULL), mImage(NULL), mGenerationId(0),
            mBlendKey(true), mOpaqueKey(false), mProgramBinaries(NULL), mProgramLength(0) { }
    ~AssetAtlas() { terminate(); destroyProgramAtlas(); }
    ...
    ANDROID_API void initProgramAtlas(int fd = 0, int length = 0, int64_t* programMap = NULL, int programCount = 0);
