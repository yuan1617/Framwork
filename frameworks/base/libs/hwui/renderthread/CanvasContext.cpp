...
void CanvasContext::setProgramAtlas(RenderThread& thread,
        int fd, int length, int64_t* programMap, int programCount) {
    thread.eglManager().setProgramAtlas(fd, length, programMap, programCount);
}
