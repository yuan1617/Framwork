    ...
    private static Ringtone getRingtone(final Context context, Uri ringtoneUri, int streamType) {
        try {
            ...
            if (ringtoneType != -1) {
                ...
                if (!isRingtoneExist(context, ringtoneUri) && ringtoneUri != null) {
                    ringtoneUri = RingtoneManager.getDefaultRingtoneUri(context, ringtoneType);
                    Log.w(TAG, "Restore Ringtone Uri " + ringtoneUri);
