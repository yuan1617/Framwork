...
public class EmergencyButton extends Button {
    ...
    KeyguardUpdateMonitorCallback mInfoCallback = new KeyguardUpdateMonitorCallback() {
        ...
        @Override
        public void onSimStateChangedUsingSubId(long subId, State simState) {
    ...
    private boolean eccButtonShouldShow() {
        Bundle bd = null;
        int subCount = mUpdateMonitor.getNumOfSubscription();
        boolean[] isServiceSupportEcc = new boolean[subCount];
    ...
    private int getCurSlotId() {
        ...
        return securityModel.getSubIndexFromSecurityMode(securityModel.getSecurityMode());
    }
}
