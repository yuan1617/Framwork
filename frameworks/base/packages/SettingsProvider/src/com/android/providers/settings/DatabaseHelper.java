...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void upgradeVibrateSettingFromNone(SQLiteDatabase db) {
        int vibrateSetting = getIntValueFromSystem(db, Settings.System.VIBRATE_ON, AudioManager.VIBRATE_SETTING_ON);
        // If the ringer vibrate value is invalid, set it to the default
        if ((vibrateSetting & 3) == AudioManager.VIBRATE_SETTING_ON) {
    ...
    private void loadVibrateWhenRingingSetting(SQLiteDatabase db) {
        ...
        /*int vibrateSetting = getIntValueFromSystem(db, Settings.System.VIBRATE_ON,
                AudioManager.VIBRATE_SETTING_ON);*/
        boolean vibrateWhenRinging = true; //((vibrateSetting & 3) == AudioManager.VIBRATE_SETTING_ON);
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
			...
			// add default value for Quick boot
			loadSetting(stmt, Settings.System.IPO_SETTING, 0);
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadSetting(stmt, Settings.Global.MOBILE_DATA, Settings.Secure.MOBILE_DATA_DEFAULT);
            ...
            loadBooleanSetting(stmt, Settings.Global.GUEST_USER_ENABLED,
                    R.bool.def_guest_user_enabled);
			//Wi-Fi Direct Name
			loadSetting(stmt, Settings.Global.WIFI_P2P_DEVICE_NAME, "iris X5");
