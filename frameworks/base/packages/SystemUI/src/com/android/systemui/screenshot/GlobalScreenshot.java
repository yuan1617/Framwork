...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        defPath.append(StorageManagerEx.getDefaultPath());
        defPath.append("/");
        defPath.append(Environment.DIRECTORY_PICTURES);
        mScreenshotDir = new File(defPath.toString(), SCREENSHOTS_DIR_NAME);
