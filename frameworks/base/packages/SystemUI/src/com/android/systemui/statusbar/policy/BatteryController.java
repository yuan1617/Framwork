...
public class BatteryController extends BroadcastReceiver {
    ...
    private boolean mShouldShowBatteryPercentage = true;
    ...
    private void refreshBatteryPrecentage() {
    	if (mLabelViews.size() > 0) {
    		TextView v = mLabelViews.get(0);
    		if (v != null) {
    			Log.i("yuanluo", "---mShouldShowBatteryPercentage----" + mShouldShowBatteryPercentage);
    			if (true) {//mShouldShowBatteryPercentage) {
    ...
    public BatteryController(Context context) {
        ...
        mShouldShowBatteryPercentage = (Settings.Secure.getInt(context.getContentResolver(), Settings.Secure.BATTERY_PERCENTAGE, 1) != 0);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
            ...
            for (int i=0; i<N; i++) {
            	...
            	v.setText(mContext.getString(R.string.status_bar_settings_battery_meter_format, mLevel));
            }

            fireBatteryLevelChanged();
            
            mBatteryPercentage = getBatteryPercentage(intent);
            Log.i("yuanluo", "mBatteryPercentage is " + mBatteryPercentage + " mShouldShowBatteryPercentage is" + mShouldShowBatteryPercentage
            		+ " mLabelView.size " + mLabelViews.size());
            refreshBatteryPrecentage();
