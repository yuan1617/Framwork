...
public class FlashlightController {
    ...
    private static final String Action_SHUTDOWN_TORCH ="shutdown_torch";
    ...
    private final TorchStateObserver mTorchStateObserver;
    ...
    public FlashlightController(Context mContext) {
        ...
        mTorchStateObserver = new TorchStateObserver(mHandler);
        mTorchStateObserver.startObserving();
    }
    ...
    public synchronized void setFlashlight(boolean enabled) {
        ...
        if (mFlashlightEnabled != enabled) {
            ...
            Settings.System.putInt(mCurrentContext.getContentResolver(), Settings.System.TORCH_STATE, enabled ? 1 : 0);
        }
    }
    ...
    private void handleError() {
        ...
        dispatchError();
        dispatchOff();
        Settings.System.putInt(mCurrentContext.getContentResolver(), Settings.System.TORCH_STATE, 0);
    ...
    private void initializeReceiver(Context context) {
        ...
        filter.addAction(Action_SHUTDOWN_TORCH);
    ...
    private class TorchStateObserver extends ContentObserver {
    	
    	public TorchStateObserver(Handler handler) {
    		super(handler);
    	}
    	@Override
    	public void onChange(boolean selfChange) {
            ...
            int state = Settings.System.getInt(mCurrentContext.getContentResolver(), Settings.System.TORCH_STATE, 0);
            if (state > 0) {
            	postUpdateFlashlight();
            } else {
            	killFlashlight();
    	...
    	public void stopObserving() {
    		ContentResolver cr = mCurrentContext.getContentResolver();
    		cr.unregisterContentObserver(this);
    	}
    	
    	public void startObserving() {
    		ContentResolver cr = mCurrentContext.getContentResolver();
    		cr.registerContentObserver(Settings.System.getUriFor(Settings.System.TORCH_STATE), true, this);
    	}
    }
