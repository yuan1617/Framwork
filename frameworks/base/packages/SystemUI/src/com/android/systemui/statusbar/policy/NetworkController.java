...
public interface NetworkController {
    ...
    public interface NetworkSignalChangedCallback {
        ...
        void onMobileDataSignalChanged(long subId, boolean enabled, int mobileSignalIconId,
                String mobileSignalContentDescriptionId, int dataTypeIconId, boolean isroam, boolean iscon, boolean isair,
                boolean activityIn, boolean activityOut,
