...
//        mConnectedApns = new ArrayList<String>();
        ...
        mSubIdMapping = new long[numPhones];
    ...
    public void notifyDataConnectionForSubscriber(long subId, int state,
        ...
        synchronized (mRecords) {
            int phoneId = getPhoneSubIdMapping(subId);//M : modification
        ...
        broadcastDataConnectionStateChanged(state, isDataConnectivityPossible, reason, apn,
                apnType, linkProperties, networkCapabilities, roaming, subId, bIsIMSChanged);
    ...
    private void broadcastDataConnectionStateChanged(int state,
            ...
            long subId, boolean bIsIMSChanged) {
    ...
    private int getPhoneSubIdMapping(long subId) {
        synchronized(mSubIdMapping) {
            for (int i = 0; i < mNumPhones; i++) {
