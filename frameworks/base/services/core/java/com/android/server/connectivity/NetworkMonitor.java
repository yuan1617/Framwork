        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case CMD_REEVALUATE:
                    ...
                    //M: Modified. In certain network environment we cant get 204 from Google server
                    //   and will block MMS if they use the same APN
                    if ((!mNetworkAgentInfo.networkCapabilities.hasCapability(
                            NetworkCapabilities.NET_CAPABILITY_INTERNET)) ||
                            mNetworkAgentInfo.networkCapabilities.hasCapability(
