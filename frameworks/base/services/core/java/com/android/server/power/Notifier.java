...
final class Notifier {
    ...
    public void onInteractiveStateChangeStarted(boolean interactive, final int reason) {
                ...
                if (mActualPowerState != POWER_STATE_AWAKE) {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (DEBUG) {
                                Slog.d(TAG, "onInteractiveChangeStarted: mPolicy.wakingUp(unblocker)");
                            }
                            mPolicy.wakingUp();
                            if (DEBUG) {
                                Slog.d(TAG, "onInteractiveChangeStarted: mActivityManagerInternal.wakingUp()");
                            }
        ...
        if (DEBUG) {
            Slog.d(TAG, "onInteractiveChangeStarted: mInputManagerInternal.setInteractive: " + interactive);
        }
                ...
                if (mActualPowerState != POWER_STATE_ASLEEP) {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (DEBUG) {
                                Slog.d(TAG, "mActivityManagerInternal.goingToSleep()");
                            }
