...
public final class PowerManagerService extends SystemService
    ...
    // Dirty bit: ipo boot
    private static final int DIRTY_BOOT_IPO = 1 << 11;
    // Dirty bit: sd card state changed
    private static final int DIRTY_SD_STATE = 1 << 12;
    // Dirty bit: smart book state changed
    private static final int DIRTY_SMARTBOOK_STATE = 1 << 13;
    ...
    private boolean updateDisplayPowerStateLocked(int dirty) {
        ...
        if ((dirty & (DIRTY_WAKE_LOCKS | DIRTY_USER_ACTIVITY | DIRTY_WAKEFULNESS
                ...
                | DIRTY_SETTINGS | DIRTY_BOOT_IPO)) != 0) {
    ...
    private int getDesiredScreenPolicyLocked() {
        ...
        if ((mWakeLockSummary & WAKE_LOCK_SCREEN_BRIGHT) != 0
                ...
                || !mBootCompleted || bypassUserActivityTimeout()) {
        ...
        public void startBacklight(int delay_msec) {
            synchronized (mLock) {
                if (SystemProperties.get("ro.mtk_ipo_support").equals("1")) {
                    ...
                    Log.d(TAG, "skip startBacklight because MTK_IPO_SUPPORT not enabled");
                }
            }
        }
        ...
        public void stopBacklight() {
            synchronized (mLock) {
                if (SystemProperties.get("ro.mtk_ipo_support").equals("1")) {
                    ...
                    Log.d(TAG, "skip stopBacklight because MTK_IPO_SUPPORT not enabled");
                }
            }
        }
