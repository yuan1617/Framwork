...
public abstract class Connection {
    ...
    /* M: call control part start */
    /**
     * @return True if it is an ECC connection.
     */
    public final boolean isEmergencyConnection() {
        return mIsEmergency;
    }
    /* M: call control part end */
    ...
    /* M: call control part start */
    /**
     * @param e True if the connection is an ECC
     */
    public final void setEmergency(boolean e) {
        mIsEmergency = e;
    }
    /* M: call control part end */
    ...
    /// M: For Volte @{
    protected void setCallInfo(Bundle bundle) {
    ...
    /* M: call control part start */
    /**
     * Base class for updating call state.
