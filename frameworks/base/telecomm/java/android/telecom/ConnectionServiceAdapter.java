...
final class ConnectionServiceAdapter implements DeathRecipient {
     ...
     * @hide
     */
    void setConferenceXmlData(String conferenceId, ConferenceXmlData xmlData) {
        Log.v(this, "setConferenceCallXml: %s, %s", conferenceId, xmlData);
        for (IConnectionServiceAdapter adapter : mAdapters) {
            try {
                adapter.setConferenceXmlData(conferenceId, xmlData);
            } catch (RemoteException ignored) {
            }
        }
    }
