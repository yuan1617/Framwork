...
public final class PhoneCapabilities {
     ...
     * @hide
     */
    public static final int ANSWER = 0x00004000;

    /**
     * Call can unhold
     * @hide
     */
    public static final int UNHOLD = 0x00008000;

    /**
     * M: Can record voice
     * @hide
     */
    public static final int VOICE_RECORD = 0x00010000;

    /**
     * M: Device support ECT(explicit call transfer).
     * @hide
     */
    public static final int ECT = 0x00020000;
    ...
    public static final int ALL = HOLD | SUPPORT_HOLD | MERGE_CONFERENCE | SWAP_CONFERENCE
            ...
            | DISCONNECT_FROM_CONFERENCE | ANSWER | UNHOLD | VOICE_RECORD | ECT;
    ...
    public static String toString(int capabilities) {
        ...
        /* M: call control part start */
        if ((capabilities & ANSWER) != 0) {
            builder.append(" ASNWER");
        }
        if ((capabilities & UNHOLD) != 0) {
            builder.append(" UNHOLD");
        }
        if ((capabilities & VOICE_RECORD) != 0) {
            builder.append(" VOICE_RECORD");
        }
        if ((capabilities & ECT) != 0) {
            builder.append(" ECT");
        }
        /* M: call control part end */
        builder.append("]");
