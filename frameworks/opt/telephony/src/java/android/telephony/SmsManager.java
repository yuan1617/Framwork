...
public final class SmsManager {
    ...
    */
     ...
     * @return <code>ArrayList</code> of <code>SmsMessage</code> objects.
     */
    private static ArrayList<SmsMessage> createMessageListFromRawRecordsByMode(long subId,
     ...
     *
     */
    private static SmsMessage createFromEfRecordByMode(long subId, int index, byte[] data,
            int mode) {
        SmsMessage sms = null;
    ...
    private long getValidSubId(long subId) {
