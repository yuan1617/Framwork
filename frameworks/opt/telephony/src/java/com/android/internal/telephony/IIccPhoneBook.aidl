...
interface IIccPhoneBook {
     ...
     * @internal
     */
    int updateUsimPBRecordsByIndexWithError(long subId, int efid, in AdnRecord record, int index);
     ...
     * @internal
     */
    int updateUsimPBRecordsBySearchWithError(long subId, int efid, in AdnRecord oldAdn, in AdnRecord newAdn);
     ...
     * @internal
     */
    List<UsimGroup> getUsimGroups(long subId);
     ...
     * @internal
     */
    String getUsimGroupById(long subId, int nGasId);
     ...
     * @internal
     */
    boolean removeUsimGroupById(long subId, int nGasId);
     ...
     * @internal
     */
    int insertUsimGroup(long subId, String grpName);
     ...
     * @internal
     */
    int updateUsimGroup(long subId, int nGasId, String grpName);
     ...
     * @internal
     */
    boolean addContactToGroup(long subId, int adnIndex, int grpIndex);
     ...
     * @internal
     */
    boolean removeContactFromGroup(long subId, int adnIndex, int grpIndex);
     ...
     * @internal
     */
    boolean updateContactToGroups(long subId, int adnIndex, in int[] grpIdList);
     ...
     * @internal
     */
    boolean moveContactFromGroupsToGroups(long subId, int adnIndex, in int[] fromGrpIdList, in int[] toGrpIdList);
     ...
     * @internal
     */
    int hasExistGroup(long subId, String grpName);
     ...
     * @internal
     */
    int getUsimGrpMaxNameLen(long subId);
     ...
     * @internal
     */
    int getUsimGrpMaxCount(long subId);
     ...
     * @internal
     */
    List<AlphaTag> getUsimAasList(long subId);
     ...
     * @internal
     */
    String getUsimAasById(long subId, int index);
     ...
     * @internal
     */
    int insertUsimAas(long subId, String aasName);
     ...
     * @internal
     */
    int getUsimAasMaxCount(long subId);
     ...
     * @internal
     */
    int getUsimAasMaxNameLen(long subId);
     ...
     * @internal
     */
    boolean updateUsimAas(long subId, int index, int pbrIndex, String aasName);
     ...
     * @internal
     */
    boolean removeUsimAasById(long subId, int index, int pbrIndex);
     ...
     * @internal
     */
    int getSneRecordLen(long subId);

    /**
     * @hide
     * @internal
    */
    boolean isAdnAccessible(long subId);
     ...
     * @internal
     */
    UsimPBMemInfo[] getPhonebookMemStorageExt(long subId);
}
