...
public final class InboundSmsTracker {
     ...
     * @param is3gpp2WapPdu true for 3GPP2 format WAP PDU; false otherwise
     */
    InboundSmsTracker(long subId, byte[] pdu, long timestamp, int destPort,
     ...
     * @param is3gpp2WapPdu true for 3GPP2 format WAP PDU; false otherwise
     */
    public InboundSmsTracker(long subId, byte[] pdu, long timestamp, int destPort,
    ...
    InboundSmsTracker(Cursor cursor, boolean isCurrentFormat3gpp2) {
        ...
        // MTK-START
        mSubId = cursor.getLong(InboundSmsHandler.SUB_ID_COLUMN);
        // MTK-END
