...
public class SubscriptionController extends ISub.Stub {
    ...
    private static ConcurrentHashMap<Integer, Long> sSimInfo =
        ...
        try {
            if (cursor != null) {
                if (cursor.moveToFirst()) {
                    ...
                    result = getSubInfoRecord(cursor);
    ...
    public int addSubInfoRecord(String iccId, int slotId) {
        ...
        try {
            if (cursor == null || !cursor.moveToFirst()) {
                ...
                newRecord = getSubInfoRecord(cursor);
                subId = cursor.getLong(cursor.getColumnIndexOrThrow(BaseColumns._ID));;
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    ...
                    Long currentSubId = sSimInfo.get(slotId);
    ...
    public int getSlotId(long subId) {
        ...
        for (Entry<Integer, Long> entry: sSimInfo.entrySet()) {
    ...
    public long[] getActiveSubIdList() {
        Set<Entry<Integer, Long>> simInfoSet = sSimInfo.entrySet();
     ...
     * @return the number of records updated
     */
    public int setDisplayNumber(String number, long subId, boolean writeToSim) {
