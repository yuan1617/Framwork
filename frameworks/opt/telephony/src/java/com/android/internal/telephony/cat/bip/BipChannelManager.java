...
class BipChannelManager {
    final public static int MAXPSCID = (SystemProperties.get("ro.mtk_bip_scws").equals("1") == true) ? 5 : 1;
    final public static int MAXUICCSERVIER = (SystemProperties.get("ro.mtk_bip_scws").equals("1") == true) ? 2 : 1;
    final public static int MAXCHANNELID = (SystemProperties.get("ro.mtk_bip_scws").equals("1") == true) ? 7 : 1;
