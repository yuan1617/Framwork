...
public class CdmaSMSDispatcher extends SMSDispatcher {
    ...
    protected void sendNewSubmitPdu(String destinationAddress, String scAddress,
        ...
        if(submitPdu == null) {
            Rlog.d(TAG, "CDMASMSDispatcher.sendNewSubmitPdu(), L, getSubmitPdu() returned null, A");
        } else {
    ...
    protected void sendNewSubmitPdu(String destinationAddress, String scAddress,
        ...
        if (submitPdu != null) {
            ...
            Rlog.e(TAG, "CDMASMSDispatcher.sendNewSubmitPdu(), L, getSubmitPdu() returned null, B");
        }
    }
    // MTK-END
    ...
    protected void sendData(String destAddr, String scAddr, int destPort, int originalPort,
        ...
        HashMap map =  getSmsTrackerMap(destAddr, scAddr, destPort, data, pdu);
        SmsTracker tracker = getSmsTracker(map, sentIntent, deliveryIntent, getFormat(), null/*messageUri*/, false);
        sendRawPdu(tracker);
    }
    ...
    public void sendMultipartTextWithExtraParams(String destAddr, String scAddr,
        ...
        for (int i = 0; i < msgCount; i++) {
            ...
            sendNewSubmitPdu(destAddr, scAddr, parts.get(i), smsHeader, encoding,
                    sentIntent, deliveryIntent, (i == (msgCount - 1)),
                    unsentPartCount, anyPartFailed, messageUri, validityPeriod, priority);
        }
    }
