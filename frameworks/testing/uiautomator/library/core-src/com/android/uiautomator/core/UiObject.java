...
public class UiObject {
    ...
    public boolean performTwoPointerGesture(Point startPoint1, Point startPoint2, Point endPoint1,
        ...
        Log.i(LOG_TAG, String.format("stepX1 = %f stepY1 = %f stepX2 = %f stepY2 = %f ", stepX1, stepY1, stepX2, stepY2));
        ...
        for (int i = 0; i < steps + 1; i++) {
            ...
            eventX2 += stepX2;
            eventY2 += stepY2;
            Log.i(LOG_TAG, String.format("step %d p1.x = %f p1.y = %f p2.x = %f p2.y = %f ", i, p1.x, p1.y, p2.x, p2.y));
        }
        ...
        Log.i(LOG_TAG, String.format("end point p1.x = %f p1.y = %f p2.x = %f p2.y = %f ",  p1.x, p1.y, p2.x, p2.y));
